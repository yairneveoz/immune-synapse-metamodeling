function model3plotCloudsArray(parameters)
...
magenta_fixed_colormap = magentaFixedColormap(64);
figure(13)
clf
set(gcf, 'Units', 'pixels',...
        'OuterPosition', [350, 50, 700, 800]);
...
%         colormap(orange_fixed_colormap)
        ...
        axis(shift_x_pixels + [-lim1 lim1 -lim1 lim1])
        xticks(shift_x_pixels + [-tick1:tick1:tick1])
        yticks(shift_y_pixels + [-tick1:tick1:tick1])
